...
import 'package:vendors_app/app/appointment_list_tile.dart';
...
class UpcomingPage extends StatefulWidget {
  UpcomingPage({@required this.database});
        ...
        return ListItemBuilder(
          showDivider: false,
            ...
            itemBuilder: (context, appointment) {
              if (appointment.status == 'pending' || appointment.status == 'confirmed' || appointment.status == 'accepted') {
